...
public class PantallaResponsableFacturacion extends javax.swing.JFrame {
	...
	private void initGUI() {
		try {
			...
			{
				reclamosFacturacionView = Controlador.getInstance().listarReclamosFacturacion();
				int size = reclamosFacturacionView.size();
				...
				for (int i = 0; i < size; i++) {
					...
					}
					{
						...
						nroReclamo.setText(Long.toString(reclamosFacturacionView.get(i).getNroReclamo()));
					}
					{
					...
					}
					{
						...
						fechaAlta.setText(formatoFecha.format(reclamosFacturacionView.get(i).getFechaAlta()));
					}
					{
					...
					}
					{
						...
						nombreCliente.setText(reclamosFacturacionView.get(i).getCliente().getNombre());
					}
					{
					...
					}
					{
						...
						dniCliente.setText(Long.toString(reclamosFacturacionView.get(i).getCliente().getDniCliente()));
					}
					{
						lEstado = new JLabel();
					...
					}
					{
						...
						if(reclamosFacturacionView.get(i).getEstado() == 1){
							estado.setText("Ingresado");
						}else if(reclamosFacturacionView.get(i).getEstado() == 2){
							estado.setText("En tratamiento");
						}else if(reclamosFacturacionView.get(i).getEstado() == 3){
					...
					}
					{
						...
						descripcion.setText(reclamosFacturacionView.get(i).getDescripcion());
					}
